...
Потоки здесь — закон о том, какое поведение система обязана обеспечить. За адресом и телом запроса обращайся к спецификации; если она расходится с потоком, следуй спецификации. Полная формулировка правила — [в обзоре канона](../README.md#потоки-описывают-обязательное-поведение-системы).
...
Адреса в таблицах ниже даны для ориентировки; действующий контракт берётся из спецификации.
